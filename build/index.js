...
const BNFeaturedPost = _ref => {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_edit_post__WEBPACK_IMPORTED_MODULE_2__.PluginDocumentSettingPanel, {
    ...
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Featured Post", "breaking-news"),
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Make this post featured post?", "breaking-news"),
    checked: postMeta[metaField] == "true",
    onChange: newValue => {
      editPost({
        meta: {
          [metaField]: newValue.toString()
        }
      });
    }
  }));
...
(0,_wordpress_plugins__WEBPACK_IMPORTED_MODULE_1__.registerPlugin)(pluginName, {
  render() {
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(BNFeaturedPost, {
      metaField: "_featured"
    });
  }
